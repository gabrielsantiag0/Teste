...
<div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 py-16 text-center md:text-left gap-10 md:gap-0 md:mr-32">
  <div>
    <h1 className="text-4xl sm:text-5xl md:text-6xl font-normal font-gallery leading-tight">
      Let's Create <br /> Something Great
    </h1>
    <p className="mt-4 text-xl sm:text-base font-dm text-white max-w-md mx-auto md:mx-0 md:text-xs">
