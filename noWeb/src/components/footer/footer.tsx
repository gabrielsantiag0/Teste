   ...
   <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 py-16">
        <div className="text-center md:text-left mb-10 md:mb-0">
          <h1 className="md:text-6xl font-gallery leading-tight">
            Let's Create <br /> Something Great
          </h1>
          <p className="mt-4 text-sm font-dm text-gray-400 max-w-md">
            We Shift You From Today's Reality To Tomorrow’s Potential, Ensuring
          </p>
        </div>

        <div className='flex'>
  <button className="w-32 h-32 bg-lime-400 text-black font-semibold font-dm text-sm rounded-full shadow-md hover:scale-105 transition-transform flex items-center justify-center gap-2">
    Let’s Talk
    <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="#1f1f1f">
      ...
      <div className="bg-[#f8f8f8] text-black">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <div className="flex flex-col md:flex-row justify-between items-center border-b pb-6 gap-6 font-dm text-sm font-medium ">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-6 text-sm text-gray-600">
            ...
            <p className='text-sm text-gray-950'>Copyright © 2025 Nex. All Rights Reserved by Gabriel Santiago.</p>
          </div>
        </div>
      </div>
    </footer>
