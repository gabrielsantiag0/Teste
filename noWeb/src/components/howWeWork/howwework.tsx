...
// import iconeHowWe1 from '../../assets/Foguete.png'
// import iconeHowWe2 from '../../assets/iconeHowWe.png'
// import iconeHowWe3 from '../../assets/iconeHowWe3.png'
...
export default function HowWeWork() {
  ...
  <div className="flex justify-center items-center gap-20 flex-wrap mt-12 w-full px-70">
    ...
    <div className="w-[250px] h-[244px]">
      <div className="flex items-center justify-center mb-4">
        <div className="w-14 h-14 border border-black rounded-full flex items-center justify-center text-2xl">
