...
<div className="flex flex-col justify-center">
  ...
  <div className="mb-6 lg:mb-2 flex justify-start">
         ...
         <span className="text-sm uppercase text-gray-500 font-semibold font-dm pl-4">
      What Sets Us Apart
    </span>
  </div>
  ...
  <p className="text-gray-400 font-dm text-xs mb-5">
...
<div className='flex-auto justify-start'>
  ...
  <p className="text-gray-400 font-dm text-xs  mt-4">
...
<div className='flex-1'>
  ...
  <p className="text-gray-400 text-xs font-dm mb-4">
  ...
  <p className="text-gray-400 text-xs font-dm mb-8">
    We Believe That The Surest Measure Of Success Is When Our Partners With Us More Than Half  
    It's More Than Just The Visuals.
  </p>

  <h3 className="text-lg sm:text-xl font-ma font-semibold mb-1 pt-8 lg:pt-12">Our Mission</h3>
  <p className="text-gray-400 text-xs font-dm mb-6">
  ...
  <div className="relative flex flex-col items-center w-full sm:w-40">
    ...
    <div className="button-color rounded-[30px] pt-14 sm:pt-16 px-4 text-center flex flex-col justify-center items-center h-32">
      <p className="text-black font-dm text-xs font-semibold leading-tight">
        Marketing Strategy
      </p>
    </div>
  </div>
  ...
  <div className="relative flex flex-col items-center w-full sm:w-40">
    ...
    <div className="button-color rounded-[30px] pt-14 sm:pt-16 px-9 text-center flex flex-col justify-center items-center h-32">
      <p className="text-black font-dm text-xs font-semibold leading-tight">UX/UI</p>
      <p className="text-black font-dm text-xs font-semibold leading-tight">Solution</p>
    </div>
  </div>
</div>
